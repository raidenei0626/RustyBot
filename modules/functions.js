module.exports = (client) => {
  ...
  client.updateUser = (message, stat) => {
    ...
    client.userDB.findOne({
      ...
      if (!userr) {
        const newUser = new client.userDB({
          name: name,
          uuid: uuid,
          rank: "unknown",
          created: client.moment(joinedDiscord).format('Do MMMM YY, HH:mm:ss'),
          joined: client.moment(JoinedZtm).format('Do MMMM YY, HH:mm:ss'),
          stats: { mCount: mCount, cmd: cmd }
        })
