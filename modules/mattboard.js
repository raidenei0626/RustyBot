  ...
  */
  ...
  const renderTemplate = (res, req, template, data = {}) => {
    const baseData = {
      ...
      avatar: req.isAuthenticated() ? client.users.get(req.user.id).avatarURL : null
    };
  ...
  app.get("/stats", (req, res) => {
    ...
    renderTemplate(res, req, "pages/stats.ejs", {
      stats: [
        ...
        ["Memory Usage", "fa fa-fw fa-tasks", (process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2) + "<span class='memUsage'>MB</span>"],
